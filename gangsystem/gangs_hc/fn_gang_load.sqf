...
if(!(_houseid isEqualTo -1)) then {
    ...
    _hqResult = [_hq,2] call HC_fnc_asynccall;
...
_player setVariable ["gang_init_done",true,true];
_group setVariable ["gang_hq_upgrades",[_queryResult select 7] call HC_fnc_mresToArray,true];
_group setVariable ["gang_permissions",[_queryResult select 8] call HC_fnc_mresToArray,true];
