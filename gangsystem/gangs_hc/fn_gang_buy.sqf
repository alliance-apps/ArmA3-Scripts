...
_cur = group _player;
_bool = [_name,true] call hc_fnc_gang_checkname;
...
_query = format ["INSERT INTO gangs (owner, name, description, hq_upgrades, permission, type) VALUES('%1', '%2', '""""', '""[]""', '%3', '%4')",_uid,[_name] call HC_fnc_mresString,[_permissions] call HC_fnc_mresArray,_type];
...
[10,_cur,_uid,[_queryResult,0]] call hc_fnc_gang_update;
